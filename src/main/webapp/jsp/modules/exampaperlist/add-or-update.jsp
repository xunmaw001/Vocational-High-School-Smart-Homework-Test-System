							...
							<div class="table-responsive mb-3">
								<form>
									<div class="form-group">
										<label>题目</label>
										<textarea readonly class="form-control" id="questionname" rows="3"></textarea>
									</div>
			...
			$.ajax({
				...
				success: function (res) {
					if (res.code == 0) {
						//将用户id保存到全局变量中
						userId = res.data.id
						userName = res.data.xueshengxingming,
						//删除旧考试记录
						reWrite();
					}
			...
			if (question.type == 0 || question.type == 2) {
				...
				for (var i = 0; i < answerOptions.length; i++) {
					...
					if(question.type == 2) {
						...
						option.innerHTML = answerOptions[i].code+"."+answerOptions[i].text;
					}

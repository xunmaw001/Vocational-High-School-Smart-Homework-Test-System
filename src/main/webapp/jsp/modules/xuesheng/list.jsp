...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="nianji" id="nianjiSelect" class="form-control form-control-sm" aria-controls="tableId">
										<option value=" "> </option>
	...
	<script>
		...
		function search(){
			...
			var nianjiIndex = document.getElementById("nianjiSelect").selectedIndex;
			var nianjiOptions = document.getElementById("nianjiSelect").options;
			var nianjiSelectedOption = nianjiOptions[nianjiIndex]
			if(nianjiSelectedOption.text != null && nianjiSelectedOption.text != ''){
				searchForm.nianji = nianjiSelectedOption.text;
			}
